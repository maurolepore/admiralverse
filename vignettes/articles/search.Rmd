...
As an example consider the toy admiralverse -- defined as every package on CRAN
today (2024-08-12) which name starts with "admiral" and has a website.
...
`dverse::document_universe()` takes the names of the packages in the admiralverse, and a
URL template pointing to each topic in each package.
